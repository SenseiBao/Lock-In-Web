...
const INITIAL_WORDS = [
    ...
    "QUICKSAND", "DROUGHT", "METEOR", "SANDSTORM", "HEATWAVE", "FOG", "GEYSER",
    ...
    // Extra Words (100)
    "UNICORN", "PHOENIX", "WEREWOLF", "MUMMY", "FAIRY", "GENIE", "TROLL", "OGRE", "MINOTAUR", "KRAKEN",
    "NARWHAL", "SLOTH", "PANDA", "RACCOON", "OTTER", "KOALA", "HEDGEHOG", "CHIMPANZEE", "POLAR BEAR", "WALRUS",
    "KETCHUP", "MUSTARD", "PRETZEL", "CINNAMON", "AVOCADO", "RAMEN", "DUMPLING", "CROISSANT", "BROWNIE",
    "MICROWAVE", "TOASTER", "BLENDER", "FLASHLIGHT", "BACKPACK", "SUITCASE", "UMBRELLA", "KEYBOARD", "MOUSEPAD", "REMOTE",
    "ELEVATOR", "ESCALATOR", "CROSSWALK", "ROUNDABOUT", "TRAFFIC JAM", "ROAD TRIP", "TRAIN STATION", "BUS STOP", "HOTEL", "THEATER",
    "TATTOO", "HAIRCUT", "SUNBURN", "SNEEZE", "HICCUP", "YAWN", "BLUSH", "LAUGH", "WHISPER", "SHOUT",
    "TELESCOPE", "MICROSCOPE", "LABYRINTH", "HONEYCOMB", "CANYON", "TSUNAMI", "MONSOON", "AURORA", "ECLIPSE", "COMET",
    "JUGGLING", "CARTWHEEL", "BACKFLIP", "KICKFLIP", "PARKOUR", "SNOWBALL", "PIGGYBACK", "TUG OF WAR", "HIDE AND SEEK", "TAG",
    "PIRATE SHIP", "SPACE STATION", "TIME MACHINE", "TREASURE MAP", "SECRET AGENT", "INVISIBLE", "MAGNET", "GRAVITY", "LASER", "HOLOGRAM",
    "SMARTWATCH", "AIRPLANE MODE", "CAPTCHA", "WIFI", "BLUETOOTH", "VIRUS", "FIREWALL", "SPAM", "GLITCH", "UPDATE"
];
